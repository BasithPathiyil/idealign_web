...
export default function Testimonial({testimonialText, avatarName, avatarDesignation, ratings}) {
  return (
    <Div className="cs-testimonial cs-style1">
      ...
      <h2 className="cs-testimonial_avatar_name  cs-white_color">{avatarName}</h2>
      <Div className="cs-testimonial_avatar_designation text-uppercase cs-white_color">{avatarDesignation}</Div>
    </Div>
  )
}
